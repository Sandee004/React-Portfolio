    ...
    },
    {
      ...
      description: (
        <>
          ...
          <span className="font-semibold text-green-500">CreatorMail</span> is a
          software that handles the creation of crypto addresses using the
          user's email. It also handles and supports the tranfetr of coins from
          one wallet to another using a person's username. Wallets creator on
          other platforms can also be imported and used seamlessly on
          Creatormail.
        </>
      ),
